...
> - ✅ 请勿将 `.env` 文件分享给他人
> - ✅ 生产环境请使用不同的配置
> - ✅ **BFF模式**: 设置 `VITE_USE_BFF=true` 并配置 `VITE_API_BASE_URL` 以启用后端代理模式 (可选)
...
│   │   │   └── DelayedInterestCalculator.js # 迟延履行利息计算器 ✨NEW
...
### v3.14 (2026-01-06) - 架构重构完成 (Current) ✨
