...
##### model: `str`, _Required_

The model used to generate the response. The server will parse this automatically, so you can set it to any value for now.

##### messages: `list[object]`, _Required_
...
##### ids: `list[str]` or `None`, _Required_
...
##### update_message: `dict[str, str|int]`, _Required_
...
##### document_list: `list[dict]`, _Required_
...
##### update_message: `dict[str, str|dict[]]`, _Required_
...
##### document_ids: `list[str]`, _Required_
...
_Asynchronously_ parses documents in the current dataset.
...
##### update_message: `dict[str, str|list[str]|int]` _Required_
...
##### question: `str`, _Required_

The user query or query keywords. Defaults to `""`.

##### dataset_ids: `list[str]`, _Required_
...
##### update_message: `dict[str, str|list[str]|dict[]]`, _Required_
...
##### update_message: `dict[str, Any]`, _Required_
