...
<div v-if="activeTab === 'regulations' && showFilters">
  ...
  <div class="smart-form-group">
    ...
    <div class="filter-tags">
      <span
        v-for="status in timelinessOptions"
...
<div style="display: flex; align-items: center; gap: 8px;">
  <span class="similarity-badge"> 相关度：{{ (result.similarity * 100).toFixed(0) }}% </span>
</div>
```
...
<p v-if="result.htmlContent" v-html="result.htmlContent" class="regulation-content"></p>
