...
| `email_notifications` | BOOLEAN     | -           | true    | 邮件通知设置    |
| `sms_notifications`   | BOOLEAN     | -           | false   | 短信通知设置    |
...
| `user_id`     | UUID        | FK          | -         | 提交用户                               |
| `type`        | TEXT        | CHECK       | -         | bug, feature, improvement, other       |
| `description` | TEXT        | -           | -         | 详细描述                               |
| `attachments` | TEXT[]      | -           | -         | 附件 URLs                              |
| `status`      | TEXT        | -           | 'pending' | pending, in_progress, resolved, closed |
| `created_at`  | TIMESTAMPTZ | -           | now()     | 创建时间                               |
