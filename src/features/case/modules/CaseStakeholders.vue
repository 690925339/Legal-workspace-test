          ...
          <div v-for="(plaintiff, index) in stakeholders.plaintiffs" :key="plaintiff.id" 
            ...
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 12px;">
              ...
              <div style="display: flex; gap: 8px;">
                <button class="icon-btn" @click="editStakeholder('plaintiff', plaintiff)"><i class="fas fa-edit"></i></button>
                <button class="icon-btn" style="color: #dc2626;" @click="deleteStakeholder('plaintiff', plaintiff.id)"><i class="fas fa-trash-alt"></i></button>
              </div>
            </div>
        ...
        <div class="modern-card">
          ...
          <div v-for="(defendant, index) in stakeholders.defendants" :key="defendant.id"
            ...
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 12px;">
              ...
              <div style="display: flex; gap: 8px;">
                <button class="icon-btn" @click="editStakeholder('defendant', defendant)"><i class="fas fa-edit"></i></button>
                <button class="icon-btn" style="color: #dc2626;" @click="deleteStakeholder('defendant', defendant.id)"><i class="fas fa-trash-alt"></i></button>
              </div>
            </div>
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 0 24px;">
      ...
      <div class="modern-card" v-if="stakeholders.thirdParties.length > 0">
        ...
        <div v-for="(thirdParty, index) in stakeholders.thirdParties" :key="thirdParty.id" 
          ...
          <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 12px;">
            ...
            <div style="display: flex; gap: 8px;">
              <button class="icon-btn" @click="editStakeholder('thirdParty', thirdParty)"><i class="fas fa-edit"></i></button>
              <button class="icon-btn" style="color: #dc2626;" @click="deleteStakeholder('thirdParty', thirdParty.id)"><i class="fas fa-trash-alt"></i></button>
            </div>
          </div>
          <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 0 24px;">
