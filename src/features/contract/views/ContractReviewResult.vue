        ...
        <div style="flex: 1; overflow-y: auto; padding: 24px; padding-bottom: 0;">
          ...
          <template v-else-if="currentStep === 3">
            ...
            <div style="display: flex; gap: 24px; border-bottom: 2px solid #f0f0f0; margin-bottom: 20px;">
              <div @click="activeResultTab = 'risk'" :style="getResultTabStyle('risk')">
              ...
              <div @click="activeResultTab = 'subject'" :style="getResultTabStyle('subject')">
...
// Computed
const highRiskCount = computed(() => reviewResults.value.filter(item => item.risk === 'high').length)
const mediumRiskCount = computed(() => reviewResults.value.filter(item => item.risk === 'medium').length)
