<template>
  <div style="display: flex; height: 100vh; overflow: hidden">
    ...
    <!-- 右侧：操作栏 -->
    <div
      style="width: 520px; background: white; display: flex; flex-direction: column; flex-shrink: 0"
    >
      <!-- 步骤指示器 -->
          ...
          <template v-else-if="currentStep === 3">
            ...
            <div style="margin-bottom: 24px">
              <div style="display: flex; align-items: center; gap: 16px; margin-bottom: 16px">
                ...
                <div>
                  <h3 style="margin: 0 0 4px 0; font-size: 16px; font-weight: 600; color: #1a1a1a">
                    审查结果
                  </h3>
            ...
            >
              ...
              >
                <div style="display: flex; align-items: center; gap: 6px">
                  <div style="width: 6px; height: 6px; border-radius: 50%; background: #f44336" />
                  <span style="font-size: 12px; color: #666; white-space: nowrap">高风险</span>
                </div>
                <span style="font-size: 18px; font-weight: 600; color: #f44336">{{
                  highRiskCount
                }}</span>
              </div>
              <div
              ...
              >
                <div style="display: flex; align-items: center; gap: 6px">
                  <div style="width: 6px; height: 6px; border-radius: 50%; background: #ff9800" />
                  <span style="font-size: 12px; color: #666; white-space: nowrap">中风险</span>
                </div>
                <span style="font-size: 18px; font-weight: 600; color: #ff9800">{{
                  mediumRiskCount
                }}</span>
              </div>
              <div
              ...
              >
                ...
                <span style="font-size: 18px; font-weight: 600; color: #fbbf24">{{
                  lowRiskCount
                }}</span>
              </div>
              <div
              ...
              >
                ...
                <span style="font-size: 18px; font-weight: 600; color: #22c55e">{{
                  passCount
                }}</span>
              </div>
            </div>
...
const getResultTabStyle = tab => ({
  padding: '12px 0',
  cursor: 'pointer',
  borderBottom: activeResultTab.value === tab ? '2px solid #1a73e8' : '2px solid transparent',
  marginBottom: '-2px',
  display: 'flex',
  alignItems: 'center',
  gap: '8px'
