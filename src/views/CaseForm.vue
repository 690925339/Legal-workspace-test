        ...
        <form @submit.prevent>
          ...
          >
            ...
            <div class="smart-card section-card">
              <div class="card-header">
                <div class="card-title">
                  <i class="fas fa-align-left" />案情描述
                </div>
              </div>
              <div class="smart-card-content">
                <div class="smart-form-group full-width">
            ...
            <div class="smart-card section-card">
              <div class="card-header">
                <div class="card-title">
                  <i class="fas fa-calculator" />财务信息
                </div>
              </div>
              <div class="smart-card-content">
                <div class="smart-form-grid">
                  <div class="smart-form-group full-width">
                    <label class="smart-label">
                      诉讼标的额 (CNY)
                      <span style="float: right; color: #64748b; font-weight: normal;">总额: {{ formatCurrency(totalClaimAmount) }}</span>
                    </label>
                  ...
                  <div class="smart-form-group">
                    ...
                    <div style="display: flex; align-items: center; gap: 12px;">
                      ...
                      >
                      <label
                        style="display: flex; align-items: center; gap: 6px; font-size: 13px; color: #334155; cursor: pointer; user-select: none;"
                        title="勾选后将自动添加到标的列表中"
                      >
                        <input
                          v-model="form.isAttorneyFeeIncluded"
                          type="checkbox"
                        >
                        包含在标的中
                      </label>
  ...
  methods: {
    resetForm() {
      this.form = {
        ...
        amount: 0, claimItems: [{ name: '', amount: '' }], attorneyFee: '', isAttorneyFeeIncluded: false, courtCost: '', billableHours: ''
      }
    },
    loadCaseData(id) {
      ...
      this.form = {
        ...
        status: 'active',
        clients: [
          { name: 'ABC 公司', type: 'company', id: '91310000XXXXXXXXXX', contactName: '王经理', contactRole: '法务总监', contactPhone: '13900139000', contactEmail: 'wang@abc.com' }
        ],
        opposingParties: [
          { name: 'XYZ 有限公司', type: 'company', rep: '李四', counsel: '王律师', contactName: '', contactRole: '', contactPhone: '', contactEmail: '' }
        ],
    ...
    addClient() {
      this.form.clients.push({ name: '', type: 'individual', id: '', contactName: '', contactRole: '', contactPhone: '', contactEmail: '' })
    },
    removeClient(index) {
    ...
    addOpposingParty() {
      this.form.opposingParties.push({ name: '', type: 'company', rep: '', counsel: '', contactName: '', contactRole: '', contactPhone: '', contactEmail: '' })
    },
